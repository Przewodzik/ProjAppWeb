<body>
    <header>
        ...
        <nav>
            ...
            <a href="index.php?id=4">Strona Główna</a> 
            <a href="index.php?id=2">Filmy</a> 
            <a href="index.php?id=1">Aktorzy</a> 
            <a href="index.php?id=6">Reżyserowie</a> 
            <a href="index.php?id=5">Kontakt</a> 
            <a href="index.php?id=3">Filmiki</a> 
            <div class="time-box">
                <div id="zegarek"></div>
                <div id="data"></div>
            </div>
